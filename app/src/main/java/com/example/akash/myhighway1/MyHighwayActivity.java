...
import com.example.akash.myhighway1.adapter.CustomAdapter2;
import com.example.akash.myhighway1.data.model.Example;
import com.example.akash.myhighway1.databinding.ActivityMyHighwayBinding;
import com.example.akash.myhighway1.data.model.User;
import com.example.akash.myhighway1.services.GPSTracker;
import com.example.akash.myhighway1.user.FriendsActivity;
import com.example.akash.myhighway1.user.MyDevices;
import com.example.akash.myhighway1.user.MyHistoryActivity;
import com.example.akash.myhighway1.user.MyVehicles;
...
public class MyHighwayActivity extends AppCompatActivity implements OnMapReadyCallback, NavigationView.OnNavigationItemSelectedListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, GoogleMap.OnInfoWindowClickListener, GoogleMap.OnInfoWindowLongClickListener, GoogleMap.InfoWindowAdapter {
    ...
    ActivityMyHighwayBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_my_highway);
        //setContentView(R.layout.activity_my_highway);
        sharedPreferences = getSharedPreferences(PREFRENCENAME, Context.MODE_PRIVATE);
        editor = sharedPreferences.edit();
        if (sharedPreferences.getString("userNamekey", "").equals("")) {
            startActivity(new Intent(MyHighwayActivity.this, LoginActivity.class));
            finish();
        }
        floatingActionButton = (FloatingActionButton) findViewById(R.id.fab);
        floatingActionButton.setTitle("AlertActivity");
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                User user = new User(MyHighwayActivity.this);
                if (myTracker.cangetLocation()) {
                    user.setLastLocationLat(myTracker.getLatitude());
                    user.setLastLocationLong(myTracker.getLongitude());
                }
                startActivity(new Intent(MyHighwayActivity.this, AlertActivity.class));
            }
        });
       ...
       window.setStatusBarColor(ContextCompat.getColor(MyHighwayActivity.this,R.color.colorWhatsapp));
...
/*        getSupportActionBar().setDisplayOptions(ActionBar.DISPLAY_SHOW_CUSTOM);
        ...
        myTracker = new GPSTracker(getApplicationContext(), MyHighwayActivity.this);
        updateMeOnserver();
        ...
        placeTypes = new ArrayAdapter<String>(MyHighwayActivity.this, R.layout.places_spinner_item, R.id.placeTypeSingleItem, placesTypeSpinner);
        radiousTypes = new ArrayAdapter<String>(MyHighwayActivity.this, R.layout.places_spinner_item, R.id.placeTypeSingleItem, radious);
        ...
        Sp1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                //Toast.makeText(MyHighwayActivity.this,""+tempTextView.getText().toString(),Toast.LENGTH_SHORT).show();
       ...
       // FReference.child("user_phone").setValue(userPhone);
        if(!userImageURLs.equals("")) {
            ...
            // Toast.makeText(MyHighwayActivity.this,myuri+":parsed",Toast.LENGTH_LONG).show();
            try {
                /*Picasso.with(MyHighwayActivity.this)
                        .load(userImageURLs)
                        .centerCrop()
                        .resize(70, 70)
                        .into(prPhoto);*/
                /*Picasso.with(MyHighwayActivity.this).load(userImageURLs)
       ...
       /* else if(userImageURLs.equals("")&&changed==0){
            //Toast.makeText(MyHighwayActivity.this,Uri.parse(userImageURLs)+":parsed",Toast.LENGTH_LONG).show();
...
/*        else {
            ...
            if(userPhone.equals("")) {
                ...
                prEmail.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        startActivity(new Intent(MyHighwayActivity.this, VerifyNumberActivity.class));
                    }
                });
            }
            else
        ...
        supportMapFragment.getMapAsync(MyHighwayActivity.this);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            ...
            case R.id.vehicle:{
                startActivity(new Intent(this, MyVehicles.class));
                break;
            }
            case R.id.history:{
            ...
            case R.id.friendlist: {
                ...
                startActivity(new Intent(MyHighwayActivity.this, FriendsActivity.class));
                break;
            }
            case R.id.aboutus:{
                startActivity(new Intent(MyHighwayActivity.this, AboutusActivity.class));
                break;
            }
            default: break;
        }
    ...
    if(id==R.id.idaddfriend_option){
        Intent intent = new Intent(MyHighwayActivity.this, FriendsActivity.class);
    ...
    /*if(id==R.id.idsetting_option){
        Intent settingIntent=new Intent(MyHighwayActivity.this,SettingsActivity.class);
        ...
        if(requestCode==CROP_FROM_CAMERA){
          ...
          croppedImage=BitmapFactory.decodeFile(photoTempUri.getPath());
            try {
                ...
                Toast.makeText(MyHighwayActivity.this, "" + photoTempUri, Toast.LENGTH_LONG).show();
        ...
        if(requestCode==CHANGE_PROFILE_PICTURE){
            ...
            /*   Bitmap bitmap = MediaStore.Images.Media.getBitmap(getContentResolver(), imageuri);
               prPhoto.setImageBitmap(bitmap);*/
                        ...
                        Toast.makeText(MyHighwayActivity.this, "Exception:" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                    ...
                    editor.commit();
                    Toast.makeText(MyHighwayActivity.this, changed + "" + imageuri.toString(), Toast.LENGTH_LONG).show();
                }
                }
            }
    }
    ...
    public boolean uploadImage(Uri uri, final String id) throws IOException {
        ...
        //final ProgressDialog progDialog = new ProgressDialog(MyHighwayActivity.this);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(MyHighwayActivity.this);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, uploadingUsingURL, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
               // progDialog.dismiss();
                Toast.makeText(MyHighwayActivity.this, response, Toast.LENGTH_LONG).show();/*
                if(response.equals("success")){
                    Toast.makeText(MyHighwayActivity.this, "Uploaded Successful", Toast.LENGTH_LONG).show();

                }
                else{
                    Toast.makeText(MyHighwayActivity.this, "Some error occurred!......", Toast.LENGTH_LONG).show();
                }*/
            }
        }, new com.android.volley.Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MyHighwayActivity.this, "Some error occurred -> " + error, Toast.LENGTH_LONG).show();
                ;
            }
        }){
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            Toast.makeText(MyHighwayActivity.this, "Security Exception:" + e.getMessage(), Toast.LENGTH_SHORT).show();
            Toast.makeText(MyHighwayActivity.this, "Provide GPS Permission", Toast.LENGTH_SHORT).show();
        }
    }
    public void setLocationOnMap(double lat,double lon){
        ...
        marker.setTag((new User(MyHighwayActivity.this)).getUserMobNumber());
    ...
    private void build_retrofit_and_get_response(String type) {
        ...
        if (!isNetworkAvailable(MyHighwayActivity.this)) {
            Toast.makeText(MyHighwayActivity.this, "Make Sure Internet is Working!", Toast.LENGTH_SHORT);
            return;
        }
            ...
            public void onResponse(Call<Example> call,Response<Example> response) {
               ...
               *//*
                   ...
                   // markerOptions[i].describeContents();
                    ...
                    Picasso.with(MyHighwayActivity.this).load(placeImages[i]).into(marker);
...
*/
            ...
            //  }
                Toast.makeText(MyHighwayActivity.this, "" + response.body().getResults().size(), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(Call<Example> call, Throwable t) {
                Toast.makeText(MyHighwayActivity.this, "Failer error:" + t.toString(), Toast.LENGTH_SHORT).show();
            }
            });
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if(requestCode==1){
            if(grantResults[0]== PackageManager.PERMISSION_DENIED){
                ...
                //(new MyHighwayActivity.MyAsyncTask()).execute();
            }
    ...
    public void editImage() {
        //Toast.makeText(MyHighwayActivity.this,"hello",Toast.LENGTH_SHORT).show();
        Intent intent = new Intent();
        intent.setType("image/*");
    ...
    protected void onStart() {
        DatabaseHandler db = new DatabaseHandler(MyHighwayActivity.this);
        CustomAdapter2 customAdapter = new CustomAdapter2(MyHighwayActivity.this, supportMapFragment, this.googleMap, db.getAllContacts());
        LinearLayoutManager layoutManager = new LinearLayoutManager(MyHighwayActivity.this, LinearLayoutManager.HORIZONTAL, true);
    ...
    public void onLocationChanged(Location location) {
        Toast.makeText(MyHighwayActivity.this,"Location changed",Toast.LENGTH_SHORT);
      *//*  t1.setText(myTracker.getLongitude()+"");
        t2.setText(myTracker.getLatitude()+"");
        if(location.hasSpeed()){
            ...
            //Toast.makeText(MyHighwayActivity.this,"Due to Network based location can't get Speed",Toast.LENGTH_SHORT).show();
            t3.setText("0 km/h");
    }*//*
    }*/
    ...
    public void onInfoWindowClick(Marker marker) {
        ...
        if(marker.getTag()!=null) {
            ...
            if (s2.length() >= 27) {
                ...
                PlaceRequest placeRequest = new PlaceRequest(MyHighwayActivity.this);
    ...
    public View getInfoContents(Marker marker) {
        ...
        if(marker.getTag()!=null) {
            ...
            Log.d("in sharedpreference:", (new User(MyHighwayActivity.this)).getUserMobNumber().toString());
            if (marker.getTag().toString().equals((new User(MyHighwayActivity.this)).getUserMobNumber())) {
    ...
    public void onInfoWindowLongClick(Marker marker) {
        ...
        Toast.makeText(MyHighwayActivity.this, "Copied to Clipboard", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onConnectionSuspended(int i) {
        Toast.makeText(MyHighwayActivity.this, "APi error: suspended connection", Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Toast.makeText(MyHighwayActivity.this, "APi error:" + connectionResult.getErrorMessage().toString(), Toast.LENGTH_SHORT).show();
    }
    @Override
    ...
    public void profilePictureDialog() {
        ...
        //ImageView profileImage=findViewById(R.id.imageviewer1);
        View dialogLayout = getLayoutInflater().inflate(R.layout.profile_image_viewer, null);
        String userimageurl = sharedPreferences.getString("userPhotoURikey", "");
        if (!userimageurl.equals("")) {
            imageLoader = com.nostra13.universalimageloader.core.ImageLoader.getInstance();
            imageLoader.init(ImageLoaderConfiguration.createDefault(getApplicationContext()));
            imageLoader.displayImage(userimageurl, (ImageView) dialogLayout.findViewById(R.id.imageviewer1));
        }
