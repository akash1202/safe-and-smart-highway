...
public class Friends extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       addmore.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
               ...
               if(totalfriends<10) {
                   ...
                   Toast.makeText(Friends.this,"You should remove before add more!!",Toast.LENGTH_LONG).show();
               }
           }
       });
      ...
      //  number12=number;
        //image12=image;
        customAdapter=new CustomAdapter(Friends.this,ContactList);  //here use only context of current activity
