    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendEmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(isNetworkAvailable(ForgetPassword.this)&&count==0){
            ...
            StringRequest stringRequest=new StringRequest(Request.Method.POST, strings[0], new com.android.volley.Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if(response.equals("1")){
                        ...
                        Toast.makeText(ForgetPassword.this,"Error in send Email",Toast.LENGTH_LONG).show();
                    }
                    else if(response.equals("3")){
                        Toast.makeText(ForgetPassword.this,"This Email is not Registered",Toast.LENGTH_LONG).show();
                    }
                    else if(response.equals("2")){
                        Toast.makeText(ForgetPassword.this,"This Phone number is not Registered",Toast.LENGTH_LONG).show();
                    }
