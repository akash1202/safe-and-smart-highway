...
import com.example.akash.myhighway1.adapter.CustomAdapter3;
...
public class MyHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayoutManager = new LinearLayoutManager(MyHistoryActivity.this);
        ...
        User user = new User(MyHistoryActivity.this);
...
/*                                  problemcode[i] = obj2.getString("emergency_code");
                            ...
                            customAdapter = new CustomAdapter3(MyHistoryActivity.this, getFragmentManager(), problems, searchView);
                            recyclerView.setAdapter(customAdapter);
                        } catch (Exception e) {
