...
public class VerifyNumberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // resendButton=(Button)findViewById(R.id.resendbutton);
        ...
        ActivityCompat.requestPermissions(VerifyNumberActivity.this, new String[]{Manifest.permission.SEND_SMS}, 1);
        ...
        fbauth.signInWithCredential(credential).addOnCompleteListener(this,new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    Intent IntentwithData = new Intent(getApplicationContext(), LoginActivity.class);
